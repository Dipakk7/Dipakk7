...
<img src="https://skillicons.dev/icons?i=python,fastapi,react,postgres,mysql,git,github,jupyter,pytorch,tensorflow,opencv,sklearn,numpy,pandas" />

<br/><br/>

*Also working with:* `Ollama` `Hugging Face` `LangChain` `Power BI`
